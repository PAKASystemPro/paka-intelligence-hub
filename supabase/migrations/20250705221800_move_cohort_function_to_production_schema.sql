-- Drops the function from the public schema if it exists there by mistake.
DROP FUNCTION IF EXISTS public.get_cohort_analysis_data(TEXT);

-- Recreates the function in the correct 'production' schema.
...
-- Grant execute permissions on the corrected function
GRANT EXECUTE ON FUNCTION production.get_cohort_analysis_data(TEXT) TO service_role;
