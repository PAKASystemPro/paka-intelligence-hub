...
const startDate = '2025-03-01T00:00:00+08:00';
const endDate = '2025-03-31T23:59:59+08:00';
...
async function processOrder(order, customerSupabaseId) {
  try {
    ...
    if (error) throw error;
    return data.id; // Return the UUID for line items
  } catch (error) {
