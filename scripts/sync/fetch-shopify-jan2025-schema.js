/**
 * Fetch Shopify Data for January 2025 (Schema Version)
 * 
 ...
 * 
 * This version explicitly uses the production schema for tables.
 */
...
async function testSupabaseConnection() {
  try {
    ...
    // Test with a simple query to the production schema
    ...
    if (error) {
      console.error('Error testing Supabase connection with production schema:', error);
      
      // Try a different approach - check if the schema exists
      console.log('Trying to check if production schema exists...');
      try {
