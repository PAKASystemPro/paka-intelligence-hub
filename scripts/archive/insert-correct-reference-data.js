...
async function createOrder(customer, orderNumber, month, isSecondOrder = false) {
  ...
  // For first orders, use a date within the cohort month
  // For second orders, use a date within the calculated month
...
async function insertReferenceData() {
  console.log('Starting insertion of reference data for January-June 2025...');
  ...
  for (const month of months) {
    ...
    for (let i = 1; i <= newCustomers; i++) {
      ...
      // Create first order - this sets the cohort month
...
insertReferenceData().catch(error => {
