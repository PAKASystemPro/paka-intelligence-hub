...
async function insertExactReferenceData() {
  console.log('Starting insertion of exact reference data for January-June 2025...');

  // Step 1: Create test customers and orders for each month
  console.log('\nStep 1: Creating test customers and orders...');
  ...
  // Step 4: Get cohort heatmap data
  console.log('\nStep 4: Getting cohort heatmap data...');
  ...
  console.log('\nExact reference data insertion completed successfully!');
}

// Run the main function
insertExactReferenceData().catch(error => {
