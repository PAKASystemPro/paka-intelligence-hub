...
async function main() {
  try {
    ...
    // Test if we can access the production schema tables using explicit schema reference
    console.log('\nTesting access to production schema tables with explicit schema reference...');
    
    // Test customers table
    console.log('Testing production.customers table...');
    ...
    // Test orders table
    console.log('\nTesting production.orders table...');
    ...
    console.log('\nTesting production.order_line_items table...');
    ...
    console.log('\nTesting production.cohort_sizes materialized view...');
    ...
    console.log('\nTesting production.cohort_heatmap materialized view...');
    ...
    if (connectionError) {
      console.error('Error testing connection:', connectionError);
    } else {
